  ...
  return (
    <div className="w-full border-t">
      <div className="max-w-5xl mx-auto py-10 px-4">
        ...
        <p className="mb-4">
          At <strong>ShaplaMart</strong>, we strive to ensure customer
          satisfaction with every purchase. However, if you are not entirely
          satisfied with your order, we are here to help with our refund and
          return policy.
        </p>
        ...
        <p className="mb-4">
          ...
          initiate a refund to your original payment method. Please note:
        </p>
        ...
        <p className="mb-4">
          ...
          account or credit card provider. It may take some time before your
          refund is officially posted. If you&quot;ve done this and you still
