...
const AboutUsScreen: React.FC = () => {
  return (
    <div className="w-full h-auto flex flex-col mt-10 mb-10 tablet:mb-20 px-4">
      <p className="text-2xl text-left font-medium">
        Top Fashion Shop in Bangladesh
      </p>
      ...
      <p className="text-justify mt-3 opacity-70 text-lg">
        ...
        fashion accessible anytime, anywhere.
      </p>

      <p className="text-2xl text-left mt-5">Baby Products You Can Trust</p>
      <p className="text-justify mt-3 opacity-70 text-lg">
        Parents can rely on ShaplaMart for high-quality baby clothing and
        essentials. Our products prioritize safety, comfort, and style, making
      ...
      <p className="text-2xl text-left opacity-70 mt-5">
        Shop confidently at ShaplaMart, your top fashion destination in
        Bangladesh!
      </p>
    </div>
  );
